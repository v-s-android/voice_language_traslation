# voice_language_traslation

 Creating a voice translation assistant using watsonx and IBM Watson Speech Libraries for Embed. 
 We building a translation assistant that can 
 - take voice input, 
 ...
 - convert it to speech using text-to-speech technology and
 -  finally play it back to the user.
